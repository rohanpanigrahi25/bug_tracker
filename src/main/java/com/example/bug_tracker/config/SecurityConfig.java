    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/milestones/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/milestones/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/milestones/**").hasRole("ADMIN")
                        .requestMatchers("/api/v1/**").authenticated() // All other endpoints require authentication
                        .anyRequest().denyAll() // Deny any other unmatched requests
                )
